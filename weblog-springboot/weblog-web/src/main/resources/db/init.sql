...
-- 插入用户表数据，id为1的用户
INSERT INTO `weblog`.`t_user` (`id`, `username`, `password`, `create_time`, `update_time`, `is_deleted`)
VALUES (1, 'admin', '$2a$10$hxxHGc2Bqz9KD4S24.N59O37kaaGRFEuP5WknZENdIsnLr9R1EiOq', '2025-01-01 12:00:00', '2025-01-01 12:00:00', 0);

-- 插入用户表数据，id为2的用户
INSERT INTO `weblog`.`t_user` (`id`, `username`, `password`, `create_time`, `update_time`, `is_deleted`)
VALUES (2, 'test', '$2a$10$L6ce4rQsyJ1k7ZCOfN6X4e5dHLyvg2X0t9JFEZBezDq0lds79Pxja', '2025-01-01 12:00:00', '2025-01-01 12:00:00', 0);

-- 插入用户角色表数据，对应admin用户
INSERT INTO `weblog`.`t_user_role` (`id`, `username`, `role`, `create_time`)
VALUES (1, 'admin', 'ROLE_ADMIN', '2025-01-01 12:00:00');

-- 插入用户角色表数据，对应test用户
INSERT INTO `weblog`.`t_user_role` (`id`, `username`, `role`, `create_time`)
VALUES (2, 'test', 'ROLE_VISITOR', '2025-01-01 12:00:00');

-- 插入博客设置表数据
INSERT INTO `weblog`.`t_blog_settings` (`id`, `logo`, `name`, `author`, `introduction`)
VALUES (1, 'http://113.44.234.225:9000/welog/weblog-logo.png', 'Lin101的博客', 'Lin101', '激扬文字');
